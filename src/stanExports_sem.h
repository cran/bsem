...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(77, 75, "end", "model_sem");
    return reader;
}
#include <stan_meta_header.hpp>
class model_sem
  : public stan::model::model_base_crtp<model_sem> {
private:
        int K;
        int Nv;
        int Ne;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_sem_namespace::model_sem";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_sem_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_sem_namespace::model_sem stan_model;
#ifndef USING_R
